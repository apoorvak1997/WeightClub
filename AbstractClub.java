...
public abstract class AbstractClub {
	 ...
	 *  
	 * 		10 POINTS): Create Persons from the supplied following CSV data (formatted as "id,age,name,weightLbs,weightLossLbs"):
	 *
	 * 					"1,25,Jim,311,11" 
	 * 					"2,21,Sam,315,15" 
	 * 					"3,17,Dan,314,14" 
	 ...
	 * 						10 POINTS: GRAPH PROJECTED 12 month Weight Loss (where each member is projected to lose 10 times more weight than original current weight loss)
	 *
	 * static void demo() { 
	 * 
	 * 
